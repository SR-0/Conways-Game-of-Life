...
* 
	...
	is in one of two possible states, live or dead, (or populated and unpopulated, respectively). Every cell interacts
...
int main() // entry point (standard)
{
	// initiate engine
	Engine engine(sf::VideoMode::getDesktopMode().width, sf::VideoMode::getDesktopMode().height, "Game of Life", false);
